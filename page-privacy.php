...
<section>
  ...
  <div class="privacy_content">
    <h2>プライバシーポリシー</h2>
    <p>株式会社estra（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
    ...
    <p> 1-3.国の機関もしくは地方公共団体またはその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって，本人の
    <p>同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき</p>
    ...
    <p>住所：〒151-0051 東京都渋谷区千駄ヶ谷5-8-4 第7瑞穂ビル 4階</p>
    <p>社名：株式会社estra</p>
    <p>Eメールアドレス：taro.y@estra.jp</p>
  </div>
</section>
<?php get_footer(); ?>